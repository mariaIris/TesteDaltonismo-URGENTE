    ...
    public void onActitivyResult(int requestCode, int resultCode, Intent intent){
        if(requestCode ==1)
            if(resultCode == RESULT_OK){
                TextView res_1 = findViewById( R.id.textView5_res_1 );
                res_1.setText( intent.getStringExtra("resposta") );
        }else if(requestCode==2){
            if(resultCode == RESULT_OK) {
                TextView res_2 = findViewById( R.id.textView6_res_2 );
                res_2.setText( intent.getStringExtra( "resposta" ) );

            }else {
                if(resultCode == RESULT_OK) {
                TextView res_3 = findViewById( R.id.textView7_res_3 );
                res_3.setText( intent.getStringExtra( "resposta" ) );
